          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col">
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-bold text-gray-900">Permissions & Access Check</h2>
              </div>
              <button
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-lg font-semibold text-gray-900">Agent Review Tool</h1>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-green-700 bg-green-50 border border-green-200 rounded-lg hover:bg-green-100 transition-all disabled:opacity-50"
            >
              <ShieldCheck className={`w-4 h-4 ${checkingPermissions ? 'animate-spin' : ''}`} />
              Check Permissions
            </button>
            {report && (
              <>
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-purple-700 bg-purple-50 border border-purple-200 rounded-lg hover:bg-purple-100 transition-all"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-orange-700 bg-orange-50 border border-orange-200 rounded-lg hover:bg-orange-100 transition-all"
                >
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        {status === 'analyzing' && (
          <div className="flex flex-col items-center justify-center py-24">
            ...
            <h2 className="text-lg font-semibold text-gray-900">Analyzing your Agentforce agents...</h2>
            <p className="text-gray-500 mt-1 text-sm">
              Connecting to Salesforce, fetching metadata, and running best practice checks.
            </p>
          </div>
        )}
          ...
          <>
            ...
            {report.agents.length > 0 && (
              <LifecycleTabs
                ...
                stageScores={currentReport?.stageScores}
              />
            )}
            ...
            {report.agents.length > 0 && (
              <>
                ...
                <div className="flex flex-wrap gap-4 items-center">
                  <div className="bg-white rounded-lg border border-gray-200 px-4 py-2 text-sm">
                    <span className="text-gray-500">Agents: </span>
                    <span className="font-semibold text-gray-900">{report.summary.totalAgents}</span>
                  </div>
                ...
                <div className="max-w-sm mx-auto">
                  <OverallScoreCard score={displayScore} grade={displayGrade} />
                </div>
                ...
                {selectedStage === 'data' ? (
                  ...
                  /* Best Practice Checks by Lifecycle Stage */
                  <BestPracticeChecks
